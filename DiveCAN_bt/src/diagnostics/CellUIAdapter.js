    ...
    switch (cellType) {
      case CELL_TYPE_DIVEO2:
        return [
          ...
          { field: 'temperature', label: 'Temp', unit: '°C', decimals: 1, scale: 0.001 },
          ...
          { field: 'pressure', label: 'Pressure', unit: 'bar', decimals: 3, scale: 0.000001 },
          { field: 'humidity', label: 'Humidity', unit: '%', decimals: 1, scale: 0.001 }
        ];
      case CELL_TYPE_O2S:
        return [
          { field: 'ppo2', label: 'PPO2', unit: 'bar', decimals: 3 }
