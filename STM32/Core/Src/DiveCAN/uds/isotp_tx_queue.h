 ...
 *
 * Must be called once at startup from CANTask before any ISO-TP operations.
 */
 ...
 * Thread-safe (uses critical section internally).
 *
 ...
 *
 * Must be called from CANTask when FC is received during multi-frame TX.
