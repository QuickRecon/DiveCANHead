...
extern "C"
{
    ...
    /* Static timouts */
    static const uint32_t TIMEOUT_100MS = pdMS_TO_TICKS(100);
    static const uint32_t TIMEOUT_500MS = pdMS_TO_TICKS(500);
    static const uint32_t TIMEOUT_1S = pdMS_TO_TICKS(1000);
    static const uint32_t TIMEOUT_4s = pdMS_TO_TICKS(4000);
