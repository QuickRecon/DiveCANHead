/**
 * @file stub_power.c
 * @brief Minimal power-subsystem stub for the O2S cell-thread test.
 *
 * oxygen_cell_o2s.c references POWER_DEVICE (= DEVICE_DT_GET(NODELABEL(power)))
 * and power_get_vbus_voltage() inside o2s_broadcast()'s VBUS-undervolt guard.
