...
def test_change_configuration_resets_calibration(power_shim_divecan_fixture: tuple[DiveCAN.DiveCAN, HWShim.HWShim, psu.PSU]) -> None:
    ...
    allAnalogConfig = configuration.Configuration(configuration.FIRMWARE_VERSION, configuration.CellType.CELL_ANALOG, configuration.CellType.CELL_ANALOG, configuration.CellType.CELL_ANALOG, configuration.PowerSelectMode.MODE_BATTERY, configuration.OxygenCalMethod.CAL_ANALOG_ABSOLUTE, True, configuration.VoltageThreshold.V_THRESHOLD_9V, configuration.PPO2ControlScheme.PPO2CONTROL_OFF, False, False)
    configuration.configure_board(divecan_client, allAnalogConfig)
    utils.calibrateBoard(divecan_client, shim_host)

    altConfig= configuration.Configuration(configuration.FIRMWARE_VERSION, configuration.CellType.CELL_ANALOG, configuration.CellType.CELL_ANALOG, configuration.CellType.CELL_ANALOG, configuration.PowerSelectMode.MODE_BATTERY, configuration.OxygenCalMethod.CAL_ANALOG_ABSOLUTE, False, configuration.VoltageThreshold.V_THRESHOLD_9V, configuration.PPO2ControlScheme.PPO2CONTROL_OFF, False, False)
